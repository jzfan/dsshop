...
class Pointorder extends AdminControl {
    ...
    public function order_info() {
        ...
        if ($order_id <= 0) {
            ds_show_dialog(lang('param_error'), url('Pointorder/pointorder_list'), 'error');
        }
        //查询订单信息
        $pointorder_model = model('pointorder');
        $order_info = $pointorder_model->getPointorderInfo(array('point_orderid' => $order_id));
        if (!$order_info) {
            ds_show_dialog(lang('admin_pointorderd_record_error'), url('Pointorder/pointorder_list'), 'error');
        }
