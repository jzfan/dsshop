...
class Statmember extends AdminControl
{
    ...
    public function showmember(){
        ...
        if (isset($this->search_arr['exporttype'])&&$this->search_arr['exporttype'] == 'excel'){
            ...
            $excel_obj->setStyle(array('id'=>'s_title','Font'=>array('FontName'=>'宋体','Size'=>'12','Bold'=>'1')));
            //header
            $excel_data[0][] = array('styleid'=>'s_title','data'=>lang('ds_member'));
            ...
            $excel_data[0][] = array('styleid'=>'s_title','data'=>lang('points_unit'));
            $excel_data[0][] = array('styleid'=>'s_title','data'=>lang('member_index_pre'));
            //data
            foreach ($member_list as $k=>$v){
