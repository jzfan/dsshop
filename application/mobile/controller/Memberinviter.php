...
class Memberinviter extends MobileMember
{
    ...
    public function index()
    {
        ...
        $portrait = imagecreatefromstring(file_get_contents(get_member_avatar($member_info['member_avatar'])));
        ...
        ds_json_encode(10000, '',array('refer_qrcode_logo' => UPLOAD_SITE_URL . '/' . ATTACH_INVITER . '/' . $member_info['member_id'] . '_poster.png', 'inviter_url' => WAP_SITE_URL . '/member/register.html?inviter_id=' . $member_info['member_id'], 'refer_qrcode_weixin' => $refer_qrcode_weixin, 'wx_error_msg' => $wx_error_msg));
    }
