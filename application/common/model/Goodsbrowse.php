...
class Goodsbrowse extends Model {
    ...
    public function getViewedGoodsList($member_id = 0, $shownum = 0) {
        ...
        if ($browselist) {
            $goods_list_tmp = model('goods')->getGoodsList(array('goods_id' => array('in', array_keys($browselist))), 'goods_id, goods_name,goods_advword, goods_promotion_price, goods_promotion_type, goods_marketprice, goods_image, gc_id, gc_id_1, gc_id_2, gc_id_3');
            $goods_list = array();
    ...
    public function addViewedGoodsToCache($goods_id, $member_id, $goods_info = array()) {
        ...
        if (!$goods_info) {
            ...
            if (is_array($goods_id)) {
                $goods_infotmp = $goods_model->getGoodsList(array('goods_id' => array('in', $goods_id)), 'goods_id,gc_id,gc_id_1,gc_id_2,gc_id_3');
                if (!$goods_infotmp) {
                    return array('state' => true);
                }
