...
$(function () {
    ...
    $("#goodsDetail").click(function () {
        window.location.href = WapSiteUrl + "/mall/product_detail.html?goods_id=" + goods_id
    });
    ...
    $(".dstouch-tag-nav").find("a").click(function () {
...
function callback() {
    $(".goods_geval").on("click", "a", function () {
        ...
        o.find(".dstouch-bigimg-layout").removeClass("hide");
        var i = o.find(".pic-box");
        o.find(".close").click(function () {
            o.find(".dstouch-bigimg-layout").addClass("hide")
        });
        ...
        Swipe(i[0], {
            ...
            callback: function (o, i) {
                $(i).parents(".dstouch-bigimg-layout").find("div").last().find("li").eq(o).addClass("cur").siblings().removeClass("cur")
            },
