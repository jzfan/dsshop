$(function() {
    $.ajax({
        ...
        success: function(result) {
            var html = template('category2', result.result);
            $("#content").append(html);
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (result) {
                            ...
                            var html = template('category3', result.result);
                            $(self).append(html);
                            $(self).addClass('open-sitem');

                            $('.product_list').click(function() {
                                location.href = WapSiteUrl + "/mall/product_list.html?gc_id=" + $(this).attr('gc_id');
                            });
                        } else {
                            location.href = WapSiteUrl + "/mall/product_list.html?gc_id=" + gc_id;
                        }
                    }
                });
            });
