$(function () {
    ...
    $("#keyword").on("input", function () {
        ...
        if (e == "") {
            ...
            $.getJSON(ApiUrl + "/goods/auto_complete", {term: $("#keyword").val()}, function (e) {
                if (e.code == 10000) {
                    var t = e.result;
                    t.WapSiteUrl = WapSiteUrl;
                    if (t.list.length > 0) {
                        $("#search_tip_list_container").html(template("search_tip_list_script", t)).show()
                    } else {
                        $("#search_tip_list_container").hide()
                    }
                }
    ...
    $.getJSON(ApiUrl + "/index/search_key_list", function (e) {
        var t = e.result;
        t.WapSiteUrl = WapSiteUrl;
        $("#hot_list_container").html(template("hot_list", t));
        $("#search_his_list_container").html(template("search_his_list", t))
    });
