...
function getCartCount(e, t) {
    ...
    if (a > 0 && $(".dstouch-nav-menu").has(".cart").length > 0) {
        $(".dstouch-nav-menu").has(".cart").find(".cart").parents("li").find("sup").show();
    ...
    $.extend($, {
        ...
        areaSelected: function (options) {
            ...
            function _init() {
                ...
                var e = '<div id="areaSelected">' + '<div class="dstouch-full-mask left">' + '<div class="dstouch-full-mask-bg"></div>' + '<div class="dstouch-full-mask-block">' + '<div class="header">' + '<div class="header-wrap">' + '<div class="header-l"><a href="javascript:void(0);"><i class="back iconfont"></i></a></div>' + '<div class="header-title">' + "<h1>选择地区</h1>" + "</div>" + '<div class="header-r"><a href="javascript:void(0);"><i class="close iconfont"></i></a></div>' + "</div>" + "</div>" + '<div class="dstouch-main-layout">' + '<div class="dstouch-single-nav">' + '<ul id="filtrate_ul" class="area">' + '<li class="selected"><a href="javascript:void(0);">一级地区</a></li>' + '<li><a href="javascript:void(0);" >二级地区</a></li>' + '<li><a href="javascript:void(0);" >三级地区</a></li>' + "</ul>" + "</div>" + '<div class="dstouch-main-layout-a"><ul class="dstouch-default-list"></ul></div>' + "</div>" + "</div>" + "</div>" + "</div>";
                $("body").append(e);
                _getAreaList();
                _bindEvent();
                _close()
            ...
            function _getAreaList() {
                $.ajax({
                    ...
                    success: function (e) {
                        ...
                        $("#areaSelected").find(".dstouch-default-list").html(a);
                        if (typeof myScrollArea == "undefined") {
                            ...
                            myScrollArea = new IScroll("#areaSelected .dstouch-main-layout-a", {
                                mouseWheel: true,
                                click: true
                            })
                        } else {
