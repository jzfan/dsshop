$(function() {
    ...
    $("#send").click(function() {
        if ($.sValid()) {
            ...
            $.ajax({type: "post", url: ApiUrl + "/Memberaccount/modify_mobile_step2.html", data: {key: e, captcha: a, codekey: t}, dataType: "json", success: function(e) {
                    if (e.code == 10000) {
                        $("#send").hide();
    ...
    $("#nextform").click(function() {
        ...
        if (a) {
            $.ajax({type: "post", url: ApiUrl + "/Memberaccount/modify_mobile_step3.html", data: {key: e, auth_code: a}, dataType: "json", success: function(e) {
                    if (e.code == 10000) {
                        layer.open({content: '解绑成功',skin: 'msg',time: 2});
                        setTimeout("location.href = WapSiteUrl+'/member/member_mobile_bind.html'", 2e3);
                    } else {
                        layer.open({content: e.message, skin: 'msg', time: 2});
                    }
                }});
