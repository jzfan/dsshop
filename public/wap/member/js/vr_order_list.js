...
$(function () {
    ...
    function r() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/Membervrorder/order_list.html?page=" + curpage + "&pagesize=" + pagesize,
            data: {
                key: e,
                state_type: t,
                order_key: a
            ...
            success: function (e) {
                ...
                var a = template("order-list-tmpl", t);
                if (reset) {
                    reset = false;
                    $("#order-list").html(a)
                } else {
    ...
    $.ajax({
        ...
        success: function (e) {
            var r = {};
            $.each(e && e.result && e.result.payment_list || [],
                function (e, t) {
                    r[t] = true
                });
