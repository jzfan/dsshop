$(function(){
    ...
    TransTpl += "<i class=\"fa fa-map-marker\"></i>为指定地区城市设置运费<\/a>\n";
    TransTpl += "<a class=\"J_ToggleBatch dssc-btn-mini\" style=\"display:none\" href=\"JavaScript:void(0);\">";
    TransTpl += "<i class=\"fa fa-map-marker\"></i>批量操作<\/a>\n";
    TransTpl += "<\/div>\n";
    TransTpl += "<\/div>\n";
    TransTpl += "<\/div>\n";
    ...
    SpecialMessage += "<span  error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"fa fa-exclamation-circle\"><\/i>首件应输入1至9999的数字<\/span>\n";
    SpecialMessage += "<span error_type=\"postage\" class=\"msg J_Message\" style=\"display:none\"><i class=\"fa fa-exclamation-circle\"><\/i>首费应输入0.00至999.99的数字<\/span>\n";
    SpecialMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"fa fa-exclamation-circle\"><\/i>续件应输入1至9999的数字<\/span>\n";
    SpecialMessage += "<span error_type=\"postageplus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"fa fa-exclamation-circle\"><\/i>续费应输入0.00至999.99的数字<\/span>\n";

    DefaultMessage = '';
    DefaultMessage += "<span error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"fa fa-exclamation-circle\"><\/i>首件应输入1至9999的数字<\/span>\n";
    DefaultMessage += "<span error_type=\"postage\" class=\"msg J_Message\" style=\"display:none\"><i class=\"fa fa-exclamation-circle\"><\/i>首费应输入0.00至999.99的数字<\/span>\n";
    DefaultMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"fa fa-exclamation-circle\"><\/i>续件应输入1至9999的数字<\/span>\n";
    DefaultMessage += "<span error_type=\"postageplus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"fa fa-exclamation-circle\"><\/i>续费应输入0.00至999.99的数字<\/span>\n";

    //记录当前起始值
    StartNum = $('.tbl-except>table>tbody>tr').size();

    //头模板
    RuleHead += "<table cellspacing=\"0\" class=\"dssc-table-style\" cellpadding=\"0\" border=\"0\">\n";
    RuleHead += "<colgroup>\n";
...
//        	obj_parent = $(this).parent().parent().parent();
    ...
    $('.trans-line').on('click','.J_BatchCheck',function(){
        $('.J_BatchField').prop('checked',$(this).prop('checked') == 'checked' ? 'checked' : false);
    });
